<div class="container-fluid mb-5">
    <div class="row border-top px-xl-5">
        <div class="col-lg-3 d-none d-lg-block">
            ...
            <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 text-center"
                id="navbar-vertical">
                <div class="navbar-nav w-100 overflow-hidden border border-2 mx-auto" style="height:auto">
                    @foreach ($categories_all as $categorie)
                        <a class="p-2 link-secondary text-center ml-5"
            ...
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto py-0">
                        ...
                        <a href="shop.html" class="nav-item nav-link">Qui sommes nous</a>
